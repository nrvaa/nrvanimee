    ...
    return (
      <div className="py-24 border-2 border-black p-12 text-center bg-swiss-muted swiss-diagonal w-full col-span-full">
        ...
        <p className="mt-4 font-bold text-swiss-red tracking-widest uppercase">
          {api.message || "Too many requests to Jikan API."}
        </p>
      </div>
    );
  }
      ...
      {api.data?.map((anime) => {
        return (
          <Link
            ...
            className="group block border-2 border-black bg-white hover:bg-swiss-red transition-colors duration-200 cursor-pointer h-full flex flex-col relative top-0 hover:-translate-y-1"
          >
            ...
            <div className="p-8 flex flex-col flex-1">
              <h3 className="font-black md:text-xl text-sm uppercase leading-tight mb-4 text-black group-hover:text-white transition-colors duration-200 wrap-break-word">
